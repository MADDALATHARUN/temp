# CRUDS Program(students)(using speech recognition and dictionary of Lists)
import speech_recognition as sr

records = {}
file_name = "student.dat"
fields = ["student_roll_no", "student_name", "student_class", "student_section", "student_percentage"]
target =""
...
def menu():
    ...
    print("Please specify which operation you would like to perform from the options above.")
